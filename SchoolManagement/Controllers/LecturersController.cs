...
namespace SchoolManagement.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "LecturerId,FirstName,LastName")] Lecturers lecturers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "LecturerId,FirstName,LastName")] Lecturers lecturers)
        {
            if (ModelState.IsValid)
            {
